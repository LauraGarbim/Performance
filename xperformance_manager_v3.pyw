...
def extrair(pdf_path):
    ...
    # Aceita tanto "XPerformance - 119889 - Ref.31.08.pdf" (formato antigo)
    # quanto "XPerformance - 119889 Nome - Ref.31.08.pdf" (nome incluído no título):
    # o texto opcional entre a conta e o "- Ref." (o nome do cliente) é ignorado.
